...
#    #p = int(self.read_pressure() / 133.322)
...
#    return "{}.{:02d}%".format(hi, hd)
  ...
  def readall(self):
    ...
    temp_raw = self.read_raw_temp()
    pres_raw = self.read_raw_pressure()
    hum_raw = self.read_raw_humidity()
    print('raw:', temp_raw, pres_raw, hum_raw)
    ...
    print('pressure:', pressure, 'milliBar')
    ...
    return temperature/100.0,pressure/100.0*0.75006157584566,humidity
